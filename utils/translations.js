...
services: {
 ...
 recent: {
  ...
  members: [
    { name: "এম আব্দুর রহমান", role: "সিইও ও প্রতিষ্ঠাতা" },
    { name: "এসকে শাহেদ", role: "ডিজিটাল মার্কেটিং ম্যানেজার" },
    { name: "তারেক হাসান", role: "সিনিয়র ফুলস্ট্যাক ডেভেলপার" },
    { name: "ইকবাল হাসান", role: "ওয়েব ডেভেলপার" },
    { name: "এমডি মাহাফুজ হোসেন", role: "ওয়েব ডেভেলপার" },
    { name: "আব্দুল্লাহ", role: "ওয়েব ডেভেলপার" },
    { name: "আরকো দেবনাথ তুর্জো", role: "সিনিয়র ক্রিয়েটিভ ডিজাইনার" },
    { name: "রেডাউন", role: "ক্রিয়েটিভ ডিজাইনার" },
    { name: "আব্দুল্লাহ", role: "ক্রিয়েটিভ ডিজাইনার" },
    { name: "সাগর", role: "হেড অব অপারেশন" }
  ]
},
 ...
 testimonials: {
  ...
  desc: "শুধু আমাদের কথায় বিশ্বাস করবেন না। আমাদের কাজ নিয়ে সন্তুষ্ট গ্রাহকরা কী বলছেন, তা নিজেই দেখে নিন।",
  reviews: [
    {
      name: "ফেনিয়ান উমরাহ",
      role: "সিইও, টেকফ্লো",
      comment: "নিয়ন কোড আমাদের ব্র্যান্ডকে সম্পূর্ণ নতুনভাবে গড়ে দিয়েছে। টিমটি অত্যন্ত দক্ষ এবং তাদের সাথে কাজ করা খুবই সহজ ছিল।"
    },
    {
      name: "এম মার্টলি",
      role: "প্রতিষ্ঠাতা, স্টার্টআপ এক্স",
      comment: "তারা যে ওয়েবসাইটটি তৈরি করেছে, তাতে আমাদের কনভার্সন রেট ২০০% বেড়েছে। নিঃসন্দেহে সুপারিশযোগ্য!"
    },
    {
      name: "মিয়া রাসেল বিডি",
      role: "মার্কেটিং ডিরেক্টর",
      comment: "তাদের এসইও কৌশল সত্যিই অসাধারণ। মাত্র ৩ মাসের মধ্যেই আমরা গুগলের প্রথম পেজে র‍্যাঙ্ক করেছি।"
    },
    {
      name: "এস কে লিংকন",
      role: "প্রোডাক্ট ম্যানেজার",
      comment: "UI/UX ডিজাইন স্কিল দারুণ। তারা আমাদের ভিশন নিখুঁতভাবে বুঝেছে এবং প্রত্যাশার চেয়েও ভালো ফল দিয়েছে।"
    },
    {
      name: "কনক শ্রাবণ",
      role: "স্বত্বাধিকারী, ফ্যাশনহাব",
      comment: "খুবই প্রফেশনাল, সৃজনশীল এবং সময়মতো ডেলিভারি। এখন পর্যন্ত যাদের সাথে কাজ করেছি, তাদের মধ্যে সেরা।"
    },
    {
      name: "মাভোজা",
      role: "সিটিও, ডাটাকর্প",
      comment: "কোডের মান এবং পারফরম্যান্স দুটোই অসাধারণ। Next.js ইমপ্লিমেন্টেশন ছিল একদম নিখুঁত।"
    }
  ]
},
...
contact: {
  tag: "যোগাযোগ করুন",
  title: "চলুন কথা বলি",
  desc: "আপনার ব্যবসাকে পরবর্তী ধাপে নিতে প্রস্তুত? ফর্মটি পূরণ করুন অথবা সরাসরি আমাদের সাথে যোগাযোগ করুন।",
  info: {
    address_title: "আমাদের ঠিকানা",
    address: "বাড়ি নং: সালেহা মঞ্জিল, ৩১/১৯, সৈয়দ আলী হোসেন রোড, রোড নং: ০২, (আল ফারুক সোসাইটি), সোনাডাঙ্গা, খুলনা-৯১০০, বাংলাদেশ",
    
    phone_title: "ফোন করুন",
    phone: "+৮৮০ ১৩৪৪-২২৪৭৮৭",
  ...
  recent: {
  tag: "আমাদের কাজ",
  title: "কাজের প্রদর্শনী",
  desc: "প্রতিটি ক্যাটাগরির জন্য আমরা প্রিমিয়াম ও আধুনিক ডিজিটাল সমাধান তৈরি করি।",
  ...
  projects: [
    {
      title: "নিয়ন ব্র্যান্ড আইডেন্টিটি",
    ...
    {
      title: "মোবাইল ব্যাংকিং অ্যাপ",
      category: "ওয়েব ডেভেলপমেন্ট",
      img: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c",
    },
    {
      title: "বিজনেস পেজ সেটআপ",
      category: "পেজ সেটআপ",
      img: "https://images.unsplash.com/photo-1559028012-481c04fa702d",
    },
    {
      title: "সোশ্যাল মিডিয়া ক্যাম্পেইন",
  ...
  details: {
    branding: {
      ...
      title_bn: "ব্র্যান্ডিং ও আইডেন্টিটি",
      desc:
        "আমরা এমন শক্তিশালী ব্র্যান্ড আইডেন্টিটি তৈরি করি যা দীর্ঘস্থায়ী প্রভাব ফেলে এবং গ্রাহকের বিশ্বাস তৈরি করে।",
      points: [
        { title: "লোগো ডিজাইন", desc: "ইউনিক ও স্মরণীয় লোগো ডিজাইন" },
        { title: "কালার সিস্টেম", desc: "প্রিমিয়াম রঙের সমন্বয়" },
        { title: "ব্র্যান্ড স্ট্র্যাটেজি", desc: "একীভূত ভিজ্যুয়াল দিকনির্দেশনা" },
      ],
    },
    ...
    web_design: {
      ...
      title_bn: "ওয়েব ডিজাইন ও ডেভেলপমেন্ট",
      desc:
        "ব্যবসার বৃদ্ধির জন্য আধুনিক, দ্রুত এবং এসইও-অপ্টিমাইজড ওয়েবসাইট তৈরি করি।",
      points: [
        { title: "UI/UX ডিজাইন", desc: "পরিষ্কার ও ব্যবহারবান্ধব ইন্টারফেস" },
        { title: "পারফরম্যান্স", desc: "দ্রুত লোডিং ও অপ্টিমাইজড স্পিড" },
        { title: "রেসপনসিভ ডিজাইন", desc: "সব ডিভাইসে পারফেক্ট অভিজ্ঞতা" },
      ],
    },
    ...
    web_development: {
      ...
      title_bn: "ওয়েব ডেভেলপমেন্ট",
      desc:
        "আধুনিক ব্যবসার জন্য স্কেলেবল, নিরাপদ এবং পারফরম্যান্স-ভিত্তিক ওয়েব অ্যাপ্লিকেশন তৈরি করি।",
      points: [
        { title: "ক্রস-প্ল্যাটফর্ম", desc: "আধুনিক ও স্কেলেবল সমাধান" },
        { title: "নিরাপত্তা", desc: "সুরক্ষিত ও নির্ভরযোগ্য আর্কিটেকচার" },
        { title: "স্কেলেবিলিটি", desc: "ভবিষ্যতের জন্য প্রস্তুত ডেভেলপমেন্ট" },
      ],
    },
    ...
    page_setup: {
      ...
      title_bn: "প্রফেশনাল পেজ সেটআপ",
      desc:
        "আমরা প্রফেশনাল বিজনেস পেজ তৈরি ও অপ্টিমাইজ করি যা ব্র্যান্ডের বিশ্বাসযোগ্যতা বাড়ায়।",
      points: [
        { title: "ফেসবুক পেজ সেটআপ", desc: "সম্পূর্ণ অপ্টিমাইজড বিজনেস পেজ" },
        { title: "ইনস্টাগ্রাম সেটআপ", desc: "প্রফেশনাল প্রোফাইল ডিজাইন" },
        { title: "ব্র্যান্ড কনসিসটেন্সি", desc: "একই ভিজ্যুয়াল ও তথ্য কাঠামো" },
      ],
    },
    ...
    digital_marketing: {
      ...
      title_bn: "ডিজিটাল মার্কেটিং",
      desc:
        "ফলাফলভিত্তিক ডিজিটাল মার্কেটিং কৌশল যা আপনার ব্যবসার রিচ ও এনগেজমেন্ট বাড়ায়।",
      points: [
        { title: "সোশ্যাল মিডিয়া মার্কেটিং", desc: "টার্গেটেড অডিয়েন্স ক্যাম্পেইন" },
        { title: "অ্যাড ম্যানেজমেন্ট", desc: "ROI ফোকাসড বিজ্ঞাপন" },
        { title: "ডাটা অ্যানালিটিক্স", desc: "ডাটা ভিত্তিক গ্রোথ স্ট্র্যাটেজি" },
      ],
    },
  },
}
